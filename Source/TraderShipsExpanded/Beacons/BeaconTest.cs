...
namespace TraderShipsExpanded
{
    ...
    {/*
        ...
        public static List<IntVec3> TradeableCellsAround(IntVec3 pos, Map map)
        {
            ...
            var modExt = Transpiler_TradeableCellsAround.GetModExt(pos, map);
            if (modExt != null && modExt.ignoreWalls)
            {
                tradeableCells = Transpiler_TradeableCellsAround.CellsIfIgnoringWalls(pos, map); 
            }
